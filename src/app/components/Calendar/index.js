...
class Calendar extends Component {
    ...
    renderContent() {
        ...
        const {
            calendarType, maxDate, minDate, renderChildren, value, events, selectable
        } = this.props;
        ...
        const longPressAction = this.drillDownAvailable ? this.drillDown : this.onLongPress
            ...
            case 'month':
                return (
                    <MonthView
                        ...
                        onLongPress={mergeFunctions(longPressAction, this.props.onClickDay)}
                        events={events}
